...
* -----------------------------
* This function reads in a map of the maze from the specified * file and stores it in private data structures maintained by * this module. In the data file, the characters '+', '-', and * '|' represent corners, horizontal walls, and vertical walls, * respectively; spaces represent open passageway squares. The * starting position is indicated by the character 'S'. For
...
pointT Start();
/*
 * Return the shortest path from the initial position to the exit.
 * */
